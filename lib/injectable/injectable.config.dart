...
import 'package:trip_tally/data/data_source/trips_data_source_impl.dart' as _i26;
...
import 'package:trip_tally/data/repositories/trips_repo_impl.dart' as _i28;
...
import 'package:trip_tally/domain/data_source/trips_data_source.dart' as _i25;
...
import 'package:trip_tally/domain/use_case/sign_out_use_case.dart' as _i24;
...
import 'package:trip_tally/injectable/modules/firebase_auth_module.dart' as _i35;
import 'package:trip_tally/injectable/modules/osm_module.dart' as _i34;
import 'package:trip_tally/injectable/modules/shared_preferences_module.dart' as _i36;
import 'package:trip_tally/presentation/pages/authentication_page/bloc/authentication_bloc.dart' as _i29;
...
import 'package:trip_tally/presentation/pages/registration_page/bloc/registration_bloc.dart' as _i23;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i22.LoginUseCase>(() => _i22.LoginUseCase(gh<_i19.AuthenticationRepo>()));
    gh.factory<_i23.RegistrationBloc>(() => _i23.RegistrationBloc(gh<_i21.CreateAccountUseCase>()));
    gh.factory<_i24.SignOutUseCase>(() => _i24.SignOutUseCase(gh<_i19.AuthenticationRepo>()));
    gh.factory<_i25.TripsDataSource>(() => _i26.TripsDataSourceImpl(gh<_i15.ApiClient>()));
    gh.factory<_i27.TripsRepo>(() => _i28.TripsRepoImpl(gh<_i25.TripsDataSource>()));
    gh.factory<_i29.AuthenticationBloc>(() => _i29.AuthenticationBloc(gh<_i22.LoginUseCase>()));
    gh.factory<_i30.CreateTripUseCase>(() => _i30.CreateTripUseCase(gh<_i27.TripsRepo>()));
...
class _$OsmModule extends _i34.OsmModule {}

class _$FirebaseAuthModule extends _i35.FirebaseAuthModule {}
