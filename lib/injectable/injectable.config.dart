...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i8.AuthenticationRemoteSource>(
        () => _i9.AuthenticationRemoteSourceImpl(gh<_i3.FirebaseAuth>()));
    gh.factory<_i10.ApiClient>(() => _i10.ApiClient(gh<_i5.Dio>()));
    gh.factory<_i11.AuthenticationRepo>(() =>
        _i12.AuthenticationRepoImpl(gh<_i8.AuthenticationRemoteSource>()));
    gh.factory<_i13.SignOutUseCase>(
        () => _i13.SignOutUseCase(gh<_i11.AuthenticationRepo>()));
    gh.factory<_i14.LoginUseCase>(
        () => _i14.LoginUseCase(gh<_i11.AuthenticationRepo>()));
    gh.factory<_i15.CreateUserUseCase>(
        () => _i15.CreateUserUseCase(gh<_i11.AuthenticationRepo>()));
    gh.factory<_i16.RegistrationBloc>(
        () => _i16.RegistrationBloc(gh<_i15.CreateUserUseCase>()));
