...
import 'package:trip_tally/injectable/modules/osm_module.dart' as _i47;
...
import 'package:trip_tally/presentation/pages/create_expenses_page/bloc/create_expenses_bloc.dart' as _i40;
...
import 'package:trip_tally/presentation/pages/new_trip_page/bloc/new_trip_bloc.dart' as _i43;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i39.CreateExpenseUseCase>(() => _i39.CreateExpenseUseCase(gh<_i25.ExpensesRepo>()));
    gh.factory<_i40.CreateExpensesBloc>(() => _i40.CreateExpensesBloc(gh<_i39.CreateExpenseUseCase>()));
    ...
    gh.factory<_i43.NewTripBloc>(() => _i43.NewTripBloc(gh<_i41.CreateTripUseCase>()));
    gh.factory<_i44.UpdateUserProfileBloc>(() => _i44.UpdateUserProfileBloc(gh<_i37.UpdateUserProfileUseCase>()));
    gh.factory<_i45.CreateTripBloc>(() => _i45.CreateTripBloc(gh<_i41.CreateTripUseCase>()));
    return this;
  }
}
...
class _$OsmModule extends _i47.OsmModule {}
