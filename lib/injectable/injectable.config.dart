...
import 'package:trip_tally/domain/use_case/location_suggestions_use_case.dart' as _i27;
...
import 'package:trip_tally/injectable/modules/osm_module.dart' as _i46;
...
import 'package:trip_tally/presentation/pages/create_trip_page/bloc/create_trip_bloc.dart' as _i43;
...
import 'package:trip_tally/presentation/utils/permissions/bloc/permissions_bloc.dart' as _i30;
...
import 'package:trip_tally/presentation/widgets/m3_widgets/maps/osm_bloc/osm_suggestions_cubit.dart' as _i29;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i27.LocationSuggestionsUseCase>(() => _i27.LocationSuggestionsUseCase(gh<_i9.OsmMapRepository>()));
    gh.factory<_i28.LoginUseCase>(() => _i28.LoginUseCase(gh<_i20.AuthenticationRepo>()));
    gh.factory<_i29.OsmSuggestionsCubit>(() => _i29.OsmSuggestionsCubit(gh<_i27.LocationSuggestionsUseCase>()));
    gh.factory<_i30.PermissionsBloc>(() => _i30.PermissionsBloc(gh<_i11.PermissionsService>()));
    gh.factory<_i31.SignOutUseCase>(() => _i31.SignOutUseCase(gh<_i20.AuthenticationRepo>()));
    gh.factory<_i32.TripsDataSource>(() => _i33.TripsDataSourceImpl(gh<_i16.ApiClient>()));
    gh.factory<_i34.TripsRepo>(() => _i35.TripsRepoImpl(gh<_i32.TripsDataSource>()));
    gh.factory<_i36.UpdateUserProfileUseCase>(() => _i36.UpdateUserProfileUseCase(gh<_i20.AuthenticationRepo>()));
    gh.factory<_i37.AddExpenseUseCase>(() => _i37.AddExpenseUseCase(gh<_i25.ExpensesRepo>()));
...
class _$OsmModule extends _i46.OsmModule {}
