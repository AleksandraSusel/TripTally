...
import 'package:trip_tally/data/data_source/trips_data_source_impl.dart' as _i32;
...
import 'package:trip_tally/data/repositories/trips_repo_impl.dart' as _i34;
...
import 'package:trip_tally/domain/data_source/trips_data_source.dart' as _i31;
...
import 'package:trip_tally/domain/repositories/trips_repo.dart' as _i33;
import 'package:trip_tally/domain/use_case/add_expense_use_case.dart' as _i36;
import 'package:trip_tally/domain/use_case/create_account_use_case.dart' as _i21;
import 'package:trip_tally/domain/use_case/create_trip_use_case.dart' as _i39;
...
import 'package:trip_tally/domain/use_case/sign_out_use_case.dart' as _i30;
import 'package:trip_tally/domain/use_case/update_user_profile_use_case.dart' as _i35;
import 'package:trip_tally/domain/utils/shared_prefs_utils.dart' as _i13;
import 'package:trip_tally/injectable/modules/api_module.dart' as _i43;
import 'package:trip_tally/injectable/modules/app_router_module.dart' as _i42;
import 'package:trip_tally/injectable/modules/firebase_auth_module.dart' as _i45;
import 'package:trip_tally/injectable/modules/osm_module.dart' as _i44;
import 'package:trip_tally/injectable/modules/shared_preferences_module.dart' as _i46;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i30.SignOutUseCase>(() => _i30.SignOutUseCase(gh<_i19.AuthenticationRepo>()));
    gh.factory<_i31.TripsDataSource>(() => _i32.TripsDataSourceImpl(gh<_i15.ApiClient>()));
    gh.factory<_i33.TripsRepo>(() => _i34.TripsRepoImpl(gh<_i31.TripsDataSource>()));
    gh.factory<_i35.UpdateUserProfileUseCase>(() => _i35.UpdateUserProfileUseCase(gh<_i19.AuthenticationRepo>()));
    gh.factory<_i36.AddExpenseUseCase>(() => _i36.AddExpenseUseCase(gh<_i24.ExpensesRepo>()));
    gh.factory<_i37.AuthenticationBloc>(() => _i37.AuthenticationBloc(
          gh<_i27.LoginUseCase>(),
          gh<_i21.CreateAccountUseCase>(),
        ));
    gh.factory<_i38.CreateExpensesBloc>(() => _i38.CreateExpensesBloc(gh<_i36.AddExpenseUseCase>()));
...
class _$AppRouterModule extends _i42.AppRouterModule {}
