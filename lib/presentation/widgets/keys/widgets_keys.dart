...
class WidgetsKeys {
  ...
  static Key get elevatedTripCardDeleteButton => const Key('elevatedTripCardDeleteButton');

  static Key get addExpenseFormNameExpense => const Key('addExpenseFormNameExpense');
