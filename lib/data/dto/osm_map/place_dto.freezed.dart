...
extension PlaceDtoPatterns on PlaceDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PlaceDto value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String name, String displayName, String category, String type, PlaceAddressDto address,
            PlaceExtraTagsDto? extratags)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _PlaceDto() when $default != null:
        return $default(_that.name, _that.displayName, _that.category, _that.type, _that.address, _that.extratags);
      case _:
        return orElse();
    }
  }
