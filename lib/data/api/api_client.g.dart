...
class _ApiClient implements ApiClient {
  ...
  Future<ExpenseCategoriesDto> getExpensesCategories() async {
    ...
    final _options = _setStreamType<ExpenseCategoriesDto>(
    ...
    late ExpenseCategoriesDto _value;
    try {
      _value = ExpenseCategoriesDto.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<GetTripsDto> getAllUserTrips() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetTripsDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'trips',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetTripsDto _value;
    try {
      _value = GetTripsDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<void> updateUserProfile({
    ...
    _data.fields.add(MapEntry('default_currency_code', defaultCurrencyCode));
  ...
  @override
  Future<void> updateTrip(String tripId, CreateTripDto dto) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = dto;
